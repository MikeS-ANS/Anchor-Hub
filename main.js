...
ipcMain.handle('export-profitability-report', async (_, { rows, settings }) => {
  ...
  // Column definitions: [header, dataKey, width]
  const S1 = [
  ...
  rows.forEach(function(row, i) {
    ...
    // Money columns
    money(ws1, r, 12); // Invoiced
    money(ws1, r, 13); // Pending
    money(ws1, r, 14); // Cost
    money(ws1, r, 15); // Gross margin $
    money(ws1, r, 17); // Effective rate
